...
public class SpaceCanon extends AI{
	...
	public static SpaceCanon makeNewSpaceCanon(double x, double y) {
	    ...
	    InteractiveAttachment att = new InteractiveAttachment(new Corner[] {peakAIAt,botAIAt,canonAt1,canonAt2,canonAt3,canonAt4,rightCornerAIAt,leftCornerAIAt},new Corner(new double[] {x ,y}), new double[] {x ,y}, 1, wayPoint);
	    ...
	    SpaceCanon ai = new SpaceCanon(corners, new double[] {x,y}, 4, new Corner(new double[] {x,y+25}, new double[] {x,y}), goalCorner);
