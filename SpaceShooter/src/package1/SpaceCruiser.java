...
public class SpaceCruiser extends LongRangeAI{
	...
	public static SpaceCruiser makeNewSpaceCruiser(double x, double y, GameObject[] enemys) {
		...
		Corner bo7 = new Corner(new double[] {x + -15, y + 10}, new double[] {x,y});
		Corner bo8 = new Corner(new double[] {x + 15, y + 10}, new double[] {x,y});
		Corner bo9 = new Corner(new double[] {x + 20, y + 35}, new double[] {x,y});
		Corner bo10 = new Corner(new double[] {x + 40, y + 10}, new double[] {x,y});
		
		Corner[] body = new Corner[]  {h11,h12,h13,h14,h15,h16,h17,h18,bo5,bo6,bo7,bo8,bo9,bo10,h28,h27,h26,h25,h24,h23,h22,h21,bo4,bo3,bo2,bo1};
	    ...
	    Corner c2 = new Corner(new double[] {x-8, y+45},new double[] {x ,y});
	    ...
	    Corner c5 = new Corner(new double[] {x-75, y+10},new double[] {x ,y});
	    Corner c6 = new Corner(new double[] {x-75, y+25},new double[] {x ,y});
	    ...
	    canon1 = new MagazineAttachment(corners, new Corner(new double[] {x,y}), new double[] {x-80,y}, 5, new Corner(new double[] {x - 80, y+50}, new double[] {x,y}), 600, 150);
	    ...
	    canon2 = new MagazineAttachment(corners, new Corner(new double[] {x,y}), new double[] {x+80,y}, 5, new Corner(new double[] {x + 80, y+50}, new double[] {x,y}), 600,150);
